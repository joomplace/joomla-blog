...
$sortFields = array(
	'i.name'         => JText::_('COM_JOOMBLOG_FIELD_HEADING_NAME'),
	'i.username'     => JText::_('COM_JOOMBLOG_FIELD_HEADING_USERNAME'),
	'i.email'        => JText::_('COM_JOOMBLOG_FIELD_HEADING_EMAIL'),
	'posts_count'    => JText::_('COM_JOOMBLOG_FIELD_HEADING_POSTS_COUNT'),
	'comments_count' => JText::_('COM_JOOMBLOG_FIELD_HEADING_COMMENTS_COUNT'),
	'i.block'        => JText::_('COM_JOOMBLOG_FIELD_HEADING_ENABLED'),
...
<form name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option=com_joomblog&view=users'); ?>" method="post" autocomplete="off">
			...
			<?php
				...
				<tr>
					<td colspan="8" align="center" >
						...
						<a class="btn btn-small" href="<?php echo JRoute::_('index.php?option=com_joomblog&task=user.add'); ?>" >
