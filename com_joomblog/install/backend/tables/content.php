...
class JTableJoomblogPosts extends JTable
{
	/**
	 * Constructor
	 *
	...
	public function check()
	{
		if (trim($this->title) == '')
		{
			$this->setError(JText::_('COM_JOOMBLOG_WARNING_PROVIDE_VALID_NAME'));
			return false;
		}
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('JoomblogPosts', 'JTable');
	...
	{
		// Deprecation warning.
		JLog::add('JTableJoomblogPosts::toXML() is deprecated.', JLog::WARNING, 'deprecated');
