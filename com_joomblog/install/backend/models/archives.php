...
class JoomBlogModelArchives extends JModelList
{
	...
	protected function getListQuery() 
	{
		...
		//$query->join('LEFT', '#__joomblog_content_tags AS ctx ON ctx.contentid=c.id');
		//$query->join('LEFT', '#__joomblog_tags AS ct ON ct.id=ctx.tag');
