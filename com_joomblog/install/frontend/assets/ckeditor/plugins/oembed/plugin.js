    ...
    CKEDITOR.plugins.add('oembed', {
        ...
        init: function (editor) {
            ...
            */
            ...
            /* Supported sites */
            CKEDITOR.dialog.add('oembedsites', function(editor) {
                return {
                    title: editor.lang.oembed.SupportedFormatsTitle,
                    width: 600,
                    ...
                    contents: [{
                        ...
                        elements: [{
                            type: 'html',
                            id: 'oembedHeader',
                            html: '<div style="height: 450px; overflow: auto; padding: 0 10px;"><table border="0" style="width: 560px"><tr><td width="33%"><b style="font-weight: bold; font-size: 1.2em;">Video</b>'+editor.lang.oembed.SupportedVideo
                                +'</td><td width="33%"><b style="font-weight: bold; font-size: 1.2em;">Audio</b>'+editor.lang.oembed.SupportedAudio
                                +'<br /><b style="font-weight: bold; font-size: 1.2em;">Photo</b>'+editor.lang.oembed.SupportedPhoto
                                +'</td><td width="33%"><b style="font-weight: bold; font-size: 1.2em;">Rich</b>'+editor.lang.oembed.SupportedRich
                                +'</td></tr></table></div>'
                        }]
                    }]
                };
            ...
            CKEDITOR.dialog.add('oembed', function(editor) {
                return {
                    ...
                    minHeight: 155,
                    onShow: function() {
                       // CKEDITOR.dialog.oembedsites.show();
